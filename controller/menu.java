...
public class menu{
	...
	public void initialize(){
		...
		try{
			Scanner scanner = new Scanner(new File("gr/ihu/gymproj/Data/GymPrograms.txt"));
	...
	public void removeAction(){
		...
		try{
				BufferedWriter writer = new BufferedWriter(new FileWriter("gr/ihu/gymproj/Data/GymPrograms.txt"));
